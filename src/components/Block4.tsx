...
const Block4 = () => {
  return (
    <section className="container overflow-hidden h-190 w-100% mx-auto  z-10">
      <div className="grid md:grid-cols-2 gap-12 md:gap-90 items-center z-10">
        ...
        <div className="md:order-2 order-1 md:pt-16 self-center">
          ...
          <p className="text-gray-700 text-lg mb-6 max-w-lg">
           Sázení může být výdělečné – pokud máš správné <br />
            informace. Většina lidí prohrává, protože sází bez <br />
             dat, bez strategie a bez plánu. My to děláme jinak.
          </p>
          <p className="text-gray-700 text-lg mb-8 max-w-lg">
            Získej přístup k ověřeným tipům, které vycházejí z <br />
             analýz, statistik a aktuálních událostí. Bez <br />
             zbytečných řečí. Jen to, co opravdu funguje.
          </p>
