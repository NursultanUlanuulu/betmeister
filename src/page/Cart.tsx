...
import { decrementQuantity, incrementQuantity, removeItem } from '../store/store';
      ...
      <div className="font-sans min-h-screen">
        ...
        <div className="bg-white pt-24 pb-20 px-4 md:px-8">
          <div className="max-w-[1200px] mx-auto">
            <div className="mb-6 flex items-center text-base">
              <Link to="/" className="text-gray py-1 px-3 rounded hover:bg-blue-500 transition-colors mr-2">
                Home
              </Link>
              <span className="mx-1 text-gray-500 font-medium">&gt;</span>
              <span className="text-black py-1 px-3 rounded font-medium ml-2">Košík</span>
            </div>
            <h1 className="text-7xl font-extrabold text-gray-900 leading-tight mt-8">Košík</h1>
          </div>
        </div>
        ...
        <div className="bg-gray-50 py-24 px-4 md:px-8 relative flex justify-center items-center h-[50vh]">
          <div className="max-w-[600px] text-center bg-white p-12 rounded-lg shadow-xl border border-gray-100">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Váš košík je prázdný.</h2>
            <p className="text-gray-600 mb-8">Vypadá to, že jste ještě nic nepřidali.</p>
            <Link to="/">
        ...
        <div className="max-w-[1300px] mx-auto bg-white relative shadow-[0_20px_60px_rgba(0,0,0,0.08)] rounded-2xl">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/3 border-r border-gray-200 px-6 md:px-8 py-6">
              <div className="text-sm font-medium text-gray-700 uppercase pb-4">PRODUKT</div>

              {cart.items.map((item) => (
                <div key={item.id} className="pt-4 md:pt-0 pb-8 border-t border-gray-200">
                    ...
                    <div className="flex items-start w-full md:w-2/3 mb-4 md:mb-0">
                      <div className="w-24 h-24 mr-4 md:mr-6 flex-shrink-0">
                        <div className="bg-gray-100 w-full h-full relative overflow-hidden rounded-md">
                          <img src={betmeister} alt={item.name} className="w-full h-full object-cover" />
                        </div>
                      </div>
                      <div className="flex-grow">
                        ...
                        <div className="flex items-center gap-3 mb-1">
                          <span className="text-gray-500 line-through text-sm">
                            {(item.originalPrice || 16999).toLocaleString('cs-CZ')} Kč
                          </span>
                          <span className="text-xl font-bold text-gray-900">{item.price.toLocaleString('cs-CZ')} Kč</span>
                        </div>
                        <div className="bg-green-100 text-green-800 font-medium px-2 py-0.5 text-xs inline-block rounded-sm mb-3">
                          UŠETŘI {calculateItemSavings(item).toLocaleString('cs-CZ')} KČ
                        </div>
            ...
            <div className="lg:w-1/3 px-6 md:px-8 py-6">
              <div className="sticky top-[96px]">
                <div className="mb-6 border-b border-gray-200 pb-4">
                  <div className="text-sm font-medium text-gray-700 uppercase mb-4">CELKEM K PLATBĚ</div>
                  <div className="mb-4">
                    <div className="relative">
                      <select id="coupon" className="w-full border border-gray-300 bg-white rounded px-3 py-2 text-sm appearance-none pr-8 focus:outline-none focus:border-black">
                        <option>Přidat kupón</option>
                      </select>
                      <svg className="w-4 h-4 text-gray-700 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="mb-8 pb-6 border-b border-gray-300 flex justify-between items-center">
                  <span className="font-medium text-gray-700">Částka celkem</span>
                  <span className="text-2xl font-bold text-gray-900">{calculateTotal().toLocaleString('cs-CZ')} Kč</span>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-center text-gray-500 text-sm py-2">NEBO</div>
